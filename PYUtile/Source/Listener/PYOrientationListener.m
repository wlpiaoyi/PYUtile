...
@property (nonatomic, assign, nullable) PYOrientationListener * listener;
...
- (void)orientationChanged:(NSNotification *)note{
    @synchronized(self.tableListeners){
        ...
        BOOL isSupportOrientation = [PYOrientationListener isSupportDeviceOrientation:_deviceOrientation_];
...
-(void) afterExcuteViewWillAppearWithTarget:(nonnull UIViewController *) target{
    UIDeviceOrientation deviceOrientation = [PYOrientationListener instanceSingle].deviceOrientation;
    if ([PYOrientationListener isSupportDeviceOrientation:deviceOrientation targetController:target]) {
        deviceOrientation = parseInterfaceOrientationToDeviceOrientation([target preferredInterfaceOrientationForPresentation]);
    }
    if (![PYOrientationListener isSupportInterfaceOrientation:self.listener.interfaceOrientation targetController:target]) {
