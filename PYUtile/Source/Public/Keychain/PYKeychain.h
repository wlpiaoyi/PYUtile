...
typedef enum {
	/** No error. */
	PYKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	PYKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	PYKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	PYKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	PYKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	PYKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	PYKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	PYKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	PYKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	PYKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	PYKeychainErrorFailedToDecode = errSecDecode
} PYKeychainErrorCode;

extern NSString *const kPYKeychainErrorDomain;

/** Account name. */
extern NSString *const kPYKeychainAccountKey;
 ...
 */
extern NSString *const kPYKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kPYKeychainClassKey;

/** Item description. */
extern NSString *const kPYKeychainDescriptionKey;

/** Item label. */
extern NSString *const kPYKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kPYKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kPYKeychainWhereKey;
...
/**
 ...
 PYKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface PYKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in PYKeychain.h for a list of keys that can be used when accessing the
