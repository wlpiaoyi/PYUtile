...
static inline id _PYBoxValue(const char *type, ...) {
    va_list v;
    va_start(v, type);
    id obj = nil;
...
#define PYBoxValue(value) _PYBoxValue(@encode(__typeof__((value))), (value))

#define py_constant(...)                 _py_constant(PYBoxValue((__VA_ARGS__)))
#define _py_constant(...)                     py_constant(__VA_ARGS__)
